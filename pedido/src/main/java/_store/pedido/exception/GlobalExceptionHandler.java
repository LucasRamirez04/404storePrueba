...
import _store.pedido.dto.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(ErroPagoException.class)
    public ResponseEntity<ErrorResponse> manejarErrorPago(ErroPagoException ex,
                                                                     HttpServletRequest request) {
        ErrorResponse error = new ErrorResponse(
                LocalDateTime.now(),
    ...
    public ResponseEntity<ErrorResponse> manejarErrorNoStock(NoStock ex,
                                                          HttpServletRequest request) {
        ErrorResponse error = new ErrorResponse(
                LocalDateTime.now(),
                HttpStatus.BAD_REQUEST.value(),
