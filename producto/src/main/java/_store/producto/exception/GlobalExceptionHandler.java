...
import _store.producto.dto.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(NoSuficienteStockException.class)
    public ResponseEntity<ErrorResponse> manejarNoSuficienteStock(NoSuficienteStockException ex,
                                                                     HttpServletRequest request) {
        ErrorResponse error = new ErrorResponse(
                LocalDateTime.now(),
